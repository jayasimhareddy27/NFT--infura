...
import { Banner, CreatorCard, Loader, NFTCard, SearchBar,Pagination } from '../components';
import { NFTContext } from '../context/NFTContext';
import { getCreators } from '../utils/getTopCreators';
import { shortenAddress,address_Profile } from '../utils/shortenAddress';
    ...
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-full minmd:w-4/5">
        ...
        {!isLoading && !nfts.length ? (
          ...
          <>
            <div className="">
              <h1 className="font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold ml-4 xs:ml-0">Top Sellers <p className='hidden'>NFT marketplace nftverse is place which provide the fullfeldged easy use this to search ourpage TFN is NFT</p></h1>
                ...
                <div ref={scrollRef} className="flex flex-row w-max overflow-x-scroll no-scrollbar select-none">
                  {topCreators.map((creator, i) => (
                    <CreatorCard
                      key={creator.seller}
                      rank={i + 1}
                      creatorImg={images[`creator${address_Profile(creator.seller)|| 1}`]}
            ...
            <div className="mt-10">
              <div className="flexBetween mx-4 sm:mx-0 minlg:mx-8 sm:flex-col sm:items-start">
                ...
                <div className="flex-1 font-poppins dark:text-white text-nft-black-1 text-lg minlg:text-4xl font-semibold sm:mb-4">
